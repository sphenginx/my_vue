 ...
 */
MarkerClusterer.prototype.getTextCallBack = function() {
 ...
 * @return 无返回值
 */
MarkerClusterer.prototype.setTextCallBack = function(callBack) {
...
function Cluster(markerClusterer){
    ...
    this._clusterMarker = new SVGIconOverlay(this._center, this.getText(), this._markerClusterer.getStyles());
 ...
 */
Cluster.prototype.getText = function () {
    //如果需自定义文字，传入自定义的回调即可
    if (this._textCallBack && typeof(this._textCallBack) == 'function') {
       return this._textCallBack(this._markers);
    }
