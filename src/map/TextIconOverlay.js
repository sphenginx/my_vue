 ...
 (function (){
    ...
    baidu.dom.getPosition = function (element) {
        ...
        if(element.getBoundingClientRect){ // IE and Gecko 1.9+
            ...
            // 但是在IE 的怪异模式下，可以被html { border: 0; } 这条css规则覆盖
            // 在IE7的标准模式下，border永远是2px，这个值通过clientLeft 和 clientTop取得
            // 但是。。。在IE 7的怪异模式，如果用户使用css覆盖了默认的medium
...
var TextIconOverlay = 
    ...
    *@param {Json Object} styles 可选参数，可选项包括：<br />
    *"<b>styles</b>":{<IconStyle>} 图标风格。 图表风格包括以下几个属性：<br />
    ...
    */
    function(position, text, styles){
        this._position = position;
        this._text = text;
        this._styles = styles || {};
        (!this._styles.url) && this._setupDefaultStyles();
    };
...
TextIconOverlay.prototype._updateCss = function() {
    ...
    this._domElement.style.cssText = this._buildCssText(this._styles);
};
